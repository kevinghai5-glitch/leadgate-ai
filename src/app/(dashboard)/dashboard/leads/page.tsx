    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="h-10 w-[180px] rounded-lg border border-white/10 bg-white/[0.05] px-3 text-sm text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
        >

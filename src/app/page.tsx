            ...
            >
              <span
                ...
                style={{
                  ...
                  height: 22,
                  borderRadius: "50%",
                  background: "rgba(255,216,124,0.18)",
                  border: "1px solid rgba(255,216,124,0.4)",
                  display: "inline-flex",
                  alignItems: "center",
                  justifyContent: "center",
                  flexShrink: 0,
              ...
              >
                <Icon name="play" size={9} stroke={0} />
              </span>
              See How It Works
            </button>
          </div>
        ...
        <div style={{ position: "relative" }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <button
              className="lg-btn-ghost"
              onClick={onCTA}
              style={{ padding: "15px 28px", borderRadius: 12, fontSize: 15, cursor: "pointer", fontWeight: 500 }}
            >
              Talk to Sales
            </button>
          </div>
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          aria-label="Close"
          style={{ position: "absolute", top: 16, right: 16, background: "transparent", border: "none", color: "#8a7d6e", cursor: "pointer", padding: 8 }}
        >
          <Icon name="x" size={18} />
        </button>
        ...
        >
          <label style={{ display: "block", fontSize: 12, color: "#a49e8e", marginBottom: 8, fontWeight: 500 }}>Work email</label>
          <input
            type="email"
            required
            value={email}
            ...
            style={{
              ...
              borderRadius: 10,
              background: "#0d0d0d",
              border: "1px solid rgba(255,216,124,0.15)",
              color: "#f5f1e6",
              fontSize: 14,
              outline: "none",
              fontFamily: "inherit",
          ...
          >
            Continue <Icon name="arrow-right" size={15} stroke={2.4} />
          </button>
        </form>
        <div style={{ fontSize: 11, color: "#6a6458", textAlign: "center", marginTop: 16 }}>
...
export default function LandingPage() {
  ...
  return (
    <div className="lg-root lg-grain">
      <LandingStyles />
      <Nav onCTA={() => setSignupOpen(true)} />
      <main>
        <Hero onCTA={() => setSignupOpen(true)} onVideo={() => setVideoOpen(true)} />
        <SocialProof />
        <Logos />
        <HowItWorks />
        <Features />
        <Testimonials />
        <Cases />
        <Pricing onCTA={() => setSignupOpen(true)} />
        <FAQ />
        <FinalCTA onCTA={() => setSignupOpen(true)} />
      </main>
      <Footer />

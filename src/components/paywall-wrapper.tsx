    ...
    <div className="relative">
      {shouldLock && (
        <div className="absolute inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30 rounded-lg">
          <div className="bg-[#0A0A0A] border border-white/10 rounded-xl p-8 shadow-2xl text-center max-w-sm mx-4">
            ...
            <Link
              href="/billing"
              className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-[#FFD700] to-[#B8860B] hover:from-[#FFE033] hover:to-[#C9960C] text-black font-semibold px-6 py-2.5 transition-colors"
            >
              Upgrade Now
            </Link>
          </div>
